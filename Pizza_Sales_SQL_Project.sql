...
FROM
    order_details
        JOIN
    pizzas ON pizzas.pizza_id = order_details.pizza_id   #817860.05
...
GROUP BY pizzas.size order by pizzas.size asc limit 1; # L size pizza
...
FROM
    ...
    GROUP BY orders.order_date) AS order_quantity;   #138
